...
const file_trip_proto_rawDesc = "" +
	...
	"\bGeometry\x122\n" +
	"\vcoordinates\x18\x01 \x03(\v2\x10.trip.CoordinateR\vcoordinates\"\xc7\x01\n" +
	"\x04Trip\x12\x0e\n" +
...
var file_trip_proto_depIdxs = []int32{
	...
	7,  // 5: trip.Route.geometry:type_name -> trip.Geometry
	4,  // 6: trip.Geometry.coordinates:type_name -> trip.Coordinate
	6,  // 7: trip.Trip.selectedFare:type_name -> trip.RideFare
